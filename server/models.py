...
# Association table to store many_to-many relationship between employees and meetings
...
class Employee(db.Model):
    ...
    #Assiciation proxy to get projects for this employee through assignments
...
class Project(db.Model):
    ...
    # Relationshio mapping the project to related assignments
    assignments = db.relationship('Assignment', back_populates='project', cascade='all, delete-orphan')

    # Association procy to get employees for this project through assignments
...
class Assignment(db.Model):
    ...
    # Relationshio mapping the assignment to related project
